...
console.log(
  `node --loader ts-node/esm src/hands.ts ${loadedConfig.numHands} ${loadedConfig.showDetail} ${loadedConfig.startingBalance} ${loadedConfig.bettingStrategy} ${loadedConfig.handsFile || ""}`,
);
